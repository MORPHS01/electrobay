...
export default function ProductCard({
  ...
  return (
    <Link
      ...
      className={`group ${fixedWidth && "max-w-[500px] min-w-[250px]"}`}
    >
      <div className="bg-white dark:bg-[#0F1125] rounded-lg shadow-md overflow-hidden transition-transform duration-300 hover:scale-103">
        ...
        <div className="p-4">
          <h2 className="text-lg font-medium mb-2 group-hover:text-blue-600 dark:group-hover:text-blue-400 line-clamp-1">
            {product.productName}
          </h2>
