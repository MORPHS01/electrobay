            ...
            {results.map((result: ProductType, i: number) => (
              ...
              >
                <div className="bg-white dark:bg-[#0F1125] rounded-lg shadow-md overflow-hidden transition-transform duration-300 hover:scale-103">
                  <div className="relative h-48 p-5 w-full bg-[#efefef] dark:bg-[#1b2048]">
                    <Image
                    ...
                    <div className="absolute bottom-0 right-0">
                      <AddToWishList product={result} productCard icon/>
                    </div>
                  </div>
                  <div className="p-4">
                    <h2 className="text-lg font-medium mb-2 group-hover:text-blue-600 dark:group-hover:text-blue-400 line-clamp-1">{result.productName}</h2>
